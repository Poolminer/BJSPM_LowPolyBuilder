import { Color3, Matrix, Mesh, MeshBuilder, Scene, StandardMaterial, Vector3, VertexBuffer, VertexData } from "@babylonjs/core";
import { Material } from "@babylonjs/core/Materials/material";
import { LowPolyAirplaneEngineBuilder, LowPolyAirplaneEngineCreationOptions } from './airplaneEngine';
import { LowPolyAirplaneWingBuilder, LowPolyAirplaneWingCreationOptions } from './airplaneWing';
...
export type LowPolyAirplaneCreationOptions = LowPolyAirplaneCreationOptionsV1;

export enum LowPolyAirplaneBuilderVersion {
    V1
}

export enum LowPolyAirplaneBody {
    B747,
    A380_STRETCH
}

export enum LowPolyAirplaneParts {
    BODY,
    MAIN_WING_LEFT,
    MAIN_WING_RIGHT,
    TAIL_WING_LEFT,
...
export class LowPolyAirplaneBuilder {
    public static GetDefaultOptions(version = LowPolyAirplaneBuilderVersion.V1): LowPolyAirplaneCreationOptions {
        switch (version) {
     ...
     */
    public static GetOptions(options?: LowPolyAirplaneCreationOptions, defaultOptions?: LowPolyAirplaneCreationOptions) {
        let _options = {} as LowPolyAirplaneCreationOptions;
     ...
     */
    public static CreateAirplane(name: string, scene: Scene, options = {} as LowPolyAirplaneCreationOptions, mergeExcludes: LowPolyAirplaneParts[] = []) {
