...
export var LowPolyAirplaneEngineBuilderVersion;
(function (LowPolyAirplaneEngineBuilderVersion) {
    LowPolyAirplaneEngineBuilderVersion[LowPolyAirplaneEngineBuilderVersion["V1"] = 0] = "V1";
})(LowPolyAirplaneEngineBuilderVersion || (LowPolyAirplaneEngineBuilderVersion = {}));
export class LowPolyAirplaneEngineBuilder {
    static GetDefaultOptions(version = LowPolyAirplaneEngineBuilderVersion.V1) {
        switch (version) {
     ...
     */
    static CreateEngine(name, scene, options = {}) {
