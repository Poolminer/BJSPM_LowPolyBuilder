...
export type LowPolyAirplaneWingCreationOptions = LowPolyAirplaneWingCreationOptionsV1;

export enum LowPolyAirplaneWingBuilderVersion {
    V1
}
export class LowPolyAirplaneWingBuilder {
    public static GetDefaultOptions(version = LowPolyAirplaneWingBuilderVersion.V1): LowPolyAirplaneWingCreationOptions {
        switch (version) {
     ...
     */
    public static GetOptions(options?: LowPolyAirplaneWingCreationOptions, defaultOptions?: LowPolyAirplaneWingCreationOptions) {
        let _options = {} as LowPolyAirplaneWingCreationOptions;
     ...
     */
    public static CreateWing(name: string, scene: Scene, options = {} as LowPolyAirplaneWingCreationOptions) {
