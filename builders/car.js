...
export var LowPolyCarParts;
(function (LowPolyCarParts) {
    LowPolyCarParts[LowPolyCarParts["WHEEL_FRONT_LEFT"] = 0] = "WHEEL_FRONT_LEFT";
    LowPolyCarParts[LowPolyCarParts["WHEEL_FRONT_RIGHT"] = 1] = "WHEEL_FRONT_RIGHT";
    LowPolyCarParts[LowPolyCarParts["WHEEL_REAR_LEFT"] = 2] = "WHEEL_REAR_LEFT";
    LowPolyCarParts[LowPolyCarParts["WHEEL_REAR_RIGHT"] = 3] = "WHEEL_REAR_RIGHT";
    LowPolyCarParts[LowPolyCarParts["LIGHT_HEAD_LEFT"] = 4] = "LIGHT_HEAD_LEFT";
    LowPolyCarParts[LowPolyCarParts["LIGHT_HEAD_RIGHT"] = 5] = "LIGHT_HEAD_RIGHT";
    LowPolyCarParts[LowPolyCarParts["LIGHT_TAIL_LEFT"] = 6] = "LIGHT_TAIL_LEFT";
    LowPolyCarParts[LowPolyCarParts["LIGHT_TAIL_RIGHT"] = 7] = "LIGHT_TAIL_RIGHT";
    LowPolyCarParts[LowPolyCarParts["LICENSE_PLATE_FRONT"] = 8] = "LICENSE_PLATE_FRONT";
    LowPolyCarParts[LowPolyCarParts["LICENSE_PLATE_REAR"] = 9] = "LICENSE_PLATE_REAR";
})(LowPolyCarParts || (LowPolyCarParts = {}));
export var LowPolyCarBuilderVersion;
(function (LowPolyCarBuilderVersion) {
    LowPolyCarBuilderVersion[LowPolyCarBuilderVersion["V1"] = 0] = "V1";
})(LowPolyCarBuilderVersion || (LowPolyCarBuilderVersion = {}));
...
export class LowPolyCarBuilder {
    static GetDefaultOptions(version = LowPolyCarBuilderVersion.V1) {
        switch (version) {
     ...
     */
    static CreateCar(name, scene, options = {}, mergeExcludes = []) {
        let _options = {};
        ...
        var pairs = [[162, 107], [162, 78], [220, 78], [251, 43], [330, 43], [330, 78], [330, 78], [330, 107], [328, 107], [317, 91], [294, 91], [283, 107], [212, 107], [201, 91], [178, 91], [167, 107], [162, 107]];
        var points = [];
        ...
        var toMerge = [customMesh, car, carClone, ws4, w4, ws5, w5, ...sideWindowMeshes];
        // wheels
