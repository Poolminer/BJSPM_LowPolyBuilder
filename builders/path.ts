...
export type LowPolyPathCreationOptions = LowPolyPathCreationOptionsV1;

export enum LowPolyPathBuilderVersion {
    V1
}

export class LowPolyPathBuilder {
    public static GetDefaultOptions(version = LowPolyPathBuilderVersion.V1): LowPolyPathCreationOptions {
        switch (version) {
     ...
     */
    public static GetOptions(options?: LowPolyPathCreationOptions, defaultOptions?: LowPolyPathCreationOptions) {
        let _options = {} as LowPolyPathCreationOptions;
     ...
     */
    public static CreatePath(name: string, scene: Scene, options = {} as LowPolyPathCreationOptions) {
