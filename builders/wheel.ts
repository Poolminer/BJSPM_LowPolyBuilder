...
type LowPolyWheelCreationOptions = LowPolyWheelCreationOptionsV1;

export enum LowPolyWheelBuilderVersion {
    V1
}

export enum LowPolyWheelType {
    CAR
}

export class LowPolyWheelBuilder {

    public static GetDefaultOptions(version = LowPolyWheelBuilderVersion.V1): LowPolyWheelCreationOptions {
        switch (version) {
     ...
     */
    public static CreateWheel(name: string, scene: Scene, options = {} as LowPolyWheelCreationOptions) {
        let _options = {} as LowPolyWheelCreationOptions;
        ...
        var tirePoints: number[] = [];
        var hubcapPoints: number[] = [];
